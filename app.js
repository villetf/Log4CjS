// Denna fil är en del av Log4CjS. Mer info finns här: https://codeplatform.domain.se/team/log4cjs
//
...
// Definierar post-endpoint för MHM
app.post('/api/mhm/log', (req, res) => {
   connectionPool.getConnection((err, connection) => {
      if (err) {
         console.log('Användaranslutning till databasen misslyckades. Se logg för mer info');
         logError(err, 'Fel vid användaranslutning till databas');
